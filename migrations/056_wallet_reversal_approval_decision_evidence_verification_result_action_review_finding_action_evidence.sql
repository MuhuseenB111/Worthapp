...
CREATE TABLE IF NOT EXISTS wallet_reversal_approval_decision_evidence_verification_result_action_review_finding_action_evidence (
    ...
    CONSTRAINT fk_finding_action_evidence_evidence
...
CREATE INDEX IF NOT EXISTS
idx_finding_action_evidence_evidence
ON wallet_reversal_approval_decision_evidence_verification_result_action_review_finding_action_evidence(
    evidence_id
);
...
'Finding action associated with the evidence record.';
...
'Finding associated with the evidence record.';
...
'Review associated with the evidence record.';
...
'Review action associated with the evidence record.';
...
'Original verification result action associated with the evidence record.';
...
'Verification result associated with the evidence record.';
...
'Evidence verification associated with the evidence record.';
...
'Approval workflow associated with the evidence record.';
...
'Wallet adjustment reversal associated with the evidence record.';
...
'Role of the evidence in supporting, contradicting, resolving, correcting, or verifying the finding action.';
